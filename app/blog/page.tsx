...
const categories = [
  ...
  },
  {
    ...
    icon: <HeartPulse className="w-4 h-4 md:w-5 md:h-5" />,
  },
  { name: "Pentesting", icon: <Briefcase className="w-4 h-4 md:w-5 md:h-5" /> },
  { name: "Programming", icon: <Code className="w-4 h-4 md:w-5 md:h-5" /> },
  {
