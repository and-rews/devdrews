        ...
        <div className="logo-flex min-h-screen flex p-24 flex-col items-center justify-between">
          ...
          <div className="about">
            ...
            <div className="right">
              ...
              <p style={{ marginTop: "1rem" }}>
                But wait, there’s more! I don’t just wear the hacker hat, I’m
                also a fullstack developer. From front-end magic to back-end
                wizardry, I craft seamless user experiences. HTML, CSS,
                JavaScript(Nextjs)? Check. Node.js, Express, MongoDB, Firebase?
                Double-check. I build web applications that dance gracefully
                between client and server, leaving users awestruck.
              </p>
              <p style={{ marginTop: "1rem" }}>
                Ah, WordPress, the Swiss Army knife of the web! I wield its
                powers to create content-driven wonders. Themes, plugins, child
                themes, I’ve brewed them all. Whether it’s a personal blog, an
                e-commerce emporium, or a client’s dream site, WordPress is my
                canvas. Let’s sprinkle some magic into the code!
              </p>
              <p style={{ marginTop: "1rem" }}>
